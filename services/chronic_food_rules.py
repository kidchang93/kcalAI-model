...
# 면류 판정용. 국물을 남기면 실제 섭취가 1인분 값보다 줄어드는 군이다 — 대한신장학회 1권 p101·
# 2권 p111 이 "국물은 먹지 않고 건더기 위주로"라고 **방향만** 말하고 감소 폭은 주지 않는다.
# 폭을 말하는 문구("크게")를 쓰지 않는다 (KCAL-19: 국물 계수 근거 없음, 2026-09-13 확인).
