...
매칭 521→546(72.3%→**75.7%**). 신규: 김·꿀·맥주·막걸리·사탕·설탕·크래커·찐빵·파스타·팬케이크·푸딩 등. 질 개선: 참치회(참치죽→참치), 햄(볶음밥_햄→햄), 미트볼·연어회·소시지구이·시리얼바 등. 남은 미매칭 175개의 다수는 **원물 과일·채소**(귤·포도·참외)와 외국 요리 — 원물은 식약처 농축산물 DB가 필요하다(후속 과제).
