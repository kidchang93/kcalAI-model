...
| **출시 전 법적 요건 (연령·환불·프라이버시 매니페스트)** | **`docs/LEGAL_COMPLIANCE.md`** (2026-07-25 조사. ⚠️ 법률 자문이 아니며 출시 전 전문가 검토 필요. 만 14세 미만 차단은 **형사처벌이 걸린 항목**이라 근거를 읽고 손댈 것) |
